<x-app-layout>
    <div class="max-w-4xl mx-auto bg-white p-6 rounded-lg shadow mt-10">
        ...
        <a href="{{ route('documents.create', $candidate) }}" class="text-blue-600 hover:underline mb-4 inline-block">
            ➕ Add new document
        </a>
        ...
        <table class="w-full border border-gray-200 mt-4">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="px-4 py-2 border">
                        <a href="{{ route('documents.edit', [$candidate, $document]) }}" class="text-green-600 hover:underline">Edit</a>
                        <form action="{{ route('documents.destroy', [$candidate, $document]) }}" method="POST" class="inline-block">
                            @csrf
                            @method('DELETE')
