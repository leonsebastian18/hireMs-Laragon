...
<head>
  ...
  <section class="bg-blue-600 text-white py-20">
    <div class="max-w-4xl mx-auto text-center">
      ...
      <a href="#jobs" class="bg-white text-blue-600 px-6 py-3 rounded-lg font-semibold shadow hover:bg-gray-100">View Open Positions</a>
    </div>
  </section>
  ...
  <section class="py-20 text-center bg-blue-600 text-white">
    ...
    <a href="#jobs" class="bg-white text-blue-600 px-6 py-3 rounded-lg font-semibold shadow hover:bg-gray-100">Explore Careers</a>
  </section>
